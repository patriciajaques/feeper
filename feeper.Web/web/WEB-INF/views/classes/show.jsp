    ...
    <jsp:body>
        ...
        <script type="text/javascript">
            ...
            function exibeQuadroDuvida(row)
            {
                ...
                $("#panel-markedquestions .panel-body").load("<c:url value='/'/>exercicios/showquestion/${idExercicio}/${idClasse}/" + row, function(){
                    $("#panel-markedquestions .panel-body").animate({ scrollTop: $("#panel-markedquestions .panel-body")[0].scrollHeight}, 1000);
                });
            }
            ...
            function exibeQuadroAnotacao(row)
            {
                ...
                $.get("<c:url value='/'/>exercicios/showannotation/${idExercicio}/${idClasse}/" + row, function(data){
