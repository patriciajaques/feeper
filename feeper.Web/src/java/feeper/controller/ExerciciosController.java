...
public class ExerciciosController extends ApplicationController {
    ...
    @ResponseBody
    public int uploaddescricao(MultipartHttpServletRequest request) {
    ...
    @ResponseBody
    public void baixardescricao(@RequestParam(value = "exercicioId", defaultValue = "0") int exercicioId,
