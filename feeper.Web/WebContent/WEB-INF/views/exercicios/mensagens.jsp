...
if (lista != null && lista.size() > 0)
{
    ...
    for (Object[] item : lista) {
        if (idPessoaAux != Integer.parseInt(item[0].toString()))
        {
            ...
            %><div class="row"><div class="col-md-12 pull-left"><h5 class="<%=idUsuarioLogado == idPessoaAux ? "pull-left" : "pull-right"%>"><c:out value="<%=item[1]%>"/> <fmt:message key="label.mensagens.diz"/>:&nbsp;</h5></div></div><%
        }
        dataCadastro = item[2].toString();
        %><div class="row"><div class="col-md-12 pull-left"><div class="alert alert-success <%=idUsuarioLogado == idPessoaAux ? "pull-left" : "pull-right"%>" style="padding:3px; margin-bottom:3px;"><c:out value="<%=item[3]%>"/></div></div></div><%
    }
