...
-- Copiando dados para a tabela feeper.configuracaosistema: ~1 rows (aproximadamente)
...
INSERT INTO `exerciciocasoteste` (`ID`, `IdExercicio`, `ativo`, `MensagemPersonalizada`, `ordem`) VALUES
	(55, 17, 1, 'Os métodos setNome/getNome não apresentaram o comportamento correto!', 1),
	(56, 17, 1, 'Os métodos setMatricula/getMatricula não apresentaram o comportamento correto!', 2),
	(57, 17, 1, 'O método ImprimeNota não foi encontrado ou não imprimiu o valor esperado!', 3),
	(58, 17, 0, 'Teste do Sistema Feeper', 4);
...
INSERT INTO `exerciciocasotestepasso` (`ID`, `idCasoTeste`, `Ordem`, `OperationType`, `ExpectedOutputType`, `ExpectedOutputName`, `ExpectedOutputValue`, `ObjectName`, `MethodName`) VALUES
	(173, 55, 1, 1, 'Aluno', 'aluno1', NULL, 'Aluno', NULL),
	(174, 55, 2, 2, NULL, NULL, NULL, 'aluno1', 'setNome'),
	(175, 55, 3, 3, 'String', NULL, 'Gilvani Schneider', 'aluno1', 'getNome'),
	(176, 56, 1, 1, 'Aluno', 'aluno1', NULL, 'Aluno', NULL),
	(177, 56, 2, 2, NULL, NULL, NULL, 'aluno1', 'setMatricula'),
	(178, 56, 3, 3, 'Integer', NULL, '1176511', 'aluno1', 'getMatricula'),
	(179, 57, 2, 1, 'Aluno', 'a1', NULL, 'Aluno', NULL),
	(180, 57, 4, 1, 'Double[]', 'notas', NULL, 'Double[5]', NULL),
	(181, 57, 6, 1, '', 'notas[0]', '', '1', NULL),
	(182, 57, 7, 1, '', 'notas[1]', '', '6', NULL),
	(183, 57, 8, 1, '', 'notas[2]', '', '8', NULL),
	(184, 57, 9, 1, '', 'notas[3]', '', '9', NULL),
	(185, 57, 9, 1, '', 'notas[4]', '', '10', NULL),
	(186, 57, 10, 2, '', '', '', 'a1', 'imprimeMedia'),
	(188, 57, 12, 3, 'Double', NULL, '6.8', 'System.Out', ''),
	(189, 58, 1, 1, 'Aluno', 'a1', NULL, 'Aluno', NULL),
	(190, 58, 2, 1, 'String', 's1', NULL, '123113', NULL),
	(191, 58, 3, 1, 'Integer', 'i1', NULL, '34', NULL),
	(192, 58, 4, 2, '', '', '', 'a1', 'setNome'),
	(193, 58, 5, 3, '', NULL, 's1', 'a1', 'getNome'),
	(194, 58, 6, 2, '', '', '', 'a1', 'setMatricula'),
	(195, 58, 7, 3, '', NULL, 'i1', 'a1', 'getMatricula'),
	(196, 58, 8, 1, '', 'a1', NULL, 'Aluno', NULL),
	(197, 58, 9, 2, '', '', '', 'a1', 'setNome'),
	(198, 58, 10, 1, '', 's1', NULL, 'a1', 'getNome'),
	(199, 58, 11, 3, '', NULL, 's1', 'a1', 'getNome');
...
INSERT INTO `exerciciocasotestepassoparametro` (`ID`, `idPasso`, `Ordem`, `ObjectType`, `ObjectName`, `ObjectValue`) VALUES
	(57, 174, 1, 'String', NULL, 'Gilvani Schneider'),
	(58, 177, 1, 'Integer', NULL, '1176511'),
	(59, 186, 1, '', NULL, 'notas'),
	(60, 192, 1, '', NULL, 's1'),
	(61, 194, 1, '', NULL, 'i1'),
	(62, 197, 1, '', NULL, 's1');
...
CREATE TABLE IF NOT EXISTS `exercicioclasseauxiliar` (
  ...
  `NomeClasse` varchar(200) DEFAULT NULL,
  `Codigo` mediumtext,
  `EhInterface` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`ID`),
  KEY `fk_exercicioSolucaoClasseExercicio_idx` (`IdExercicio`),
...
-- Copiando dados para a tabela feeper.exercicioclasseauxiliar: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `exercicioclasseauxiliar` DISABLE KEYS */;
INSERT INTO `exercicioclasseauxiliar` (`ID`, `IdExercicio`, `NomeClasse`, `Codigo`, `EhInterface`) VALUES
	(30, 17, 'Aluno', 'import java.io.PrintWriter;\r\n\r\npublic class Aluno {\r\n\r\n	private String nome;\r\n	private Integer matricula;\r\n\r\n	public void imprimeMedia(Double[] notas) {}\r\n}\r\n', 1);
...
-- Copiando dados para a tabela feeper.pessoa: ~3 rows (aproximadamente)
...
INSERT INTO `pessoa` (`ID`, `Nome`, `Email`, `Senha`, `DataCadastro`, `DataUltimoAcesso`, `Ativo`, `IdPerfil`, `PossuiFoto`) VALUES
	...
	(8, 'Gilvani Admin', 'gilschneider90@gmail.com', 'a6d414ac4f293187dd42025834925f7', '2014-05-18 17:40:30', '2015-03-02 23:02:19', 1, 1, 1);
...
-- Copiando dados para a tabela feeper.telaperfil: ~182 rows (aproximadamente)
...
-- Copiando dados para a tabela feeper.turma: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela feeper.turmaexercicio: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela feeper.uploadtemp: ~1 rows (aproximadamente)
