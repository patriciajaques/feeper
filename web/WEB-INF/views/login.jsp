                        ...
                        <div class="panel-body">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <input type="email" class="form-control" id="txtEmail" placeholder="<fmt:message key="label.email"/>">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control" id="txtSenha" placeholder="<fmt:message key="label.senha"/>">
                                </div>
